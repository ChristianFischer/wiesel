...
namespace wiesel {
	 ...
	 */
	class WIESEL_CORE_EXPORT Shader : public virtual SharedObject
	{
	private:
		Shader();
	...
	public:
		 ...
		 */
		static WIESEL_CORE_EXPORT Shader *compile(const std::string &source, ShaderType type);

		/**
		 * @brief compile a shader from source code.
		 * @return the created shader on success, \c NULL when compiling failed.
		 */
		static WIESEL_CORE_EXPORT Shader *compile(DataSource *source, ShaderType type);
	 ...
	 */
	class WIESEL_CORE_EXPORT ShaderProgram : public virtual SharedObject
	{
	public:
		/**
