...
namespace wiesel {
	 ...
	 */
	WIESEL_CORE_EXPORT int logmsg(LogLevel level, const char *tag, const char *message, ...)
	#if defined(__GNUC__)
	 ...
	 */
	class WIESEL_CORE_EXPORT Log : public std::basic_ostream< char, std::char_traits<char> >
	{
	public:
